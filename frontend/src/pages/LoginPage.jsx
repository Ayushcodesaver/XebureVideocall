            ...
            <div className="mb-8 flex flex-col items-center sm:items-start justify-center gap-3">
              <div className="flex items-center justify-center sm:justify-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500 -mt-1">Fresh Connections</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="text-right">
                      <a href="#" className="text-xs text-[#00A19B] hover:text-[#00837e] transition-colors hover:underline">
                        Forgot password?
                      </a>
                    </div>
                    ...
                    <button 
                      type="submit" 
                      className="btn bg-gradient-to-r from-[#00A19B] to-[#00837e] hover:from-[#00837e] hover:to-[#00A19B] text-white border-none rounded-xl py-3 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
                      disabled={isPending}
                    >
                      {isPending ? (
                        <>
                    ...
                    <div className="text-center mt-2">
                      <p className="text-sm text-gray-600">
                        ...
                        <Link to="/signup" className="text-[#00A19B] hover:text-[#00837e] font-semibold hover:underline transition-all">
                          Create free account
                        </Link>
                      </p>
                    </div>
              ...
              <div className="text-center space-y-3 mt-6">
                ...
                <div className="flex flex-col gap-2 mt-4 text-left">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <div className="w-1.5 h-1.5 bg-[#00A19B] rounded-full"></div>
